...
public class TicTacToeGUI extends Application {
  ...
  private void setupMenus() {
    ...
    MenuItem bView = new MenuItem("Button");
    MenuItem tView = new MenuItem("TextArea");
    MenuItem dView = new MenuItem("Drawing");
    views.getItems().addAll(bView, tView, dView);
    ...
    bView.setOnAction(menuListener);
    tView.setOnAction(menuListener);
    dView.setOnAction(menuListener);
  }
